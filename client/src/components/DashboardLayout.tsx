...
import { LayoutDashboard, LogOut, PanelLeft, BarChart2, TrendingUp, Database, Activity, BookOpen, Cpu } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Activity, label: "数据源健康", path: "/health" },
];
...
export default function DashboardLayout({
  ...
  // Allow unauthenticated users to browse - they'll be prompted when needed
            ...
            {user ? (
              ...
              >
                ...
                <div className="flex-1 min-w-0 group-data-[collapsible=icon]:hidden">
                  ...
                  <p className="text-xs text-primary">点击登录 / 注册</p>
                </div>
              </button>
            )}
          </SidebarFooter>
